...
export const addProduct = async (req, res) => {
    try {
        let { productName, seats,suitcases,bags, imgUrl, price, type, category} = req.body;
        ...
        let newProduct = await ProductModel.create({ productName, seats,suitcases,bags, imgUrl, price, type, category});
        res.json(newProduct);
